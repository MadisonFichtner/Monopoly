...
public class BoardTest {
	...
	public void test_game_over() {
		...
		players[0] = new Player("Madison", "Fichtner");
		players[1] = new Player("Cody", "Stoner");
		players[2] = new Player("Trent", "Baker");
		players[3] = new Player("Logan", "Bonney");
		players[0].money += 500;						//Guarantees that we expect players[0] to win with 500 more dollars than anyone else (net worth of 2000 since everyone starts with 1500)
