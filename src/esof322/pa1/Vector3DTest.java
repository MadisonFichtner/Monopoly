...
public class Vector3DTest 
{
	...
	public void testSubtract() 
        {
            Vector3D subtractingVector = new Vector3D(f, f, f); //Subtracting vector (3,3,3)
            Vector3D actualVector = new Vector3D(x, y, z); //Vector being subtracted tp (2,1,0)
            Vector3D expectedVector = new Vector3D(-1, -2, -3); // Expected value of (2-1,1-3,0-3)
